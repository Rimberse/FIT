            ...
            {isTrackerVisible
                ? <>
                    ...
                    <div className="flex justify-evenly items-center">
                        ...
                        <button className="inline-block p-2 text-center align-middle uppercase rounded-lg shadow-lg ring-offset-2 ring-2 ring-emerald-900/50 hover:ring-emerald-800 w-52 h-12 text-xl text-white bg-emerald-700 hover:bg-emerald-800 active:bg-emerald-900 focus:ring-zinc-300 mx-7 my-7">Finish</button>
                    </div>
                </>
