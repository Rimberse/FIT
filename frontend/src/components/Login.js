    ...
    return(
        <section className="flex flex-row w-2/5 h-screen justify-center items-center mx-auto my-auto">
            <form onSubmit={handleSubmit} className="w-full">
                <h1 className="lg:text-3xl text-xl font-semibold text-violet-700">Login</h1>
                ...
                <button type="submit" className="lg:text-lg text-sm font-medium tracking-wide px-7 py-2 rounded-md bg-violet-700 text-white hover:bg-indigo-700 duration-500">Login</button>
            </form>
        </section>
    );
}
